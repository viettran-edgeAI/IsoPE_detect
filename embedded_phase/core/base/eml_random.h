...
namespace eml {
    ...
    */
    ...
    private:
        ...
        static entropy_func_t &entropy_source() { static entropy_func_t fn = nullptr; return fn; }
        ...
        static inline uint64_t entropy64() {
            auto fn = entropy_source();
            return fn ? fn() : platform_entropy64();
        }
    ...
    public:
        eml_random() {
            if (has_global()) {
                ...
                base_seed = splitmix64(entropy64());
            }
        ...
        void init(uint64_t seed, bool use_provided_seed = true) {
            if (use_provided_seed) {
                ...
                base_seed = splitmix64(entropy64() ^ seed);
            }
            engine.seed(base_seed, base_seed ^ 0xda3e39cb94b95bdbULL);
        }
        ...
        // Entropy source control (optional for platform customization)
        static void setEntropySource(entropy_func_t fn) { entropy_source() = fn; }
        static void clearEntropySource() { entropy_source() = nullptr; }
        static bool hasEntropySource() { return entropy_source() != nullptr; }
