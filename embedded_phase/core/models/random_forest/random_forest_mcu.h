...
namespace eml{
    ...
    private:
        ...
        struct NodeStats {
            b_vector<sample_idx_type, 16> labelCounts; 
        ...
        SplitInfo findBestSplit(const vector<sample_idx_type>& indices, sample_idx_type begin, sample_idx_type end,
            ...
            // Base label counts
            b_vector<sample_idx_type, 16> baseLabelCounts(numLabels, 0);
            for (sample_idx_type k = begin; k < end; ++k) {
            ...
            b_vector<sample_idx_type, 16> counts;
            ...
            if (quant_bits == 1) {
                for (const auto& featureID : selectedFeatures) {
                    ...
                    b_vector<sample_idx_type, 16> leftCounts(numLabels, 0), rightCounts(numLabels, 0);
