...
namespace eml {
    ...
    */
    ...
    public:
        ...
        vector<sample_idx_type> samples_per_label; // index = label, value = count

        // Packed node layout bits (loaded from model config)
    ...
    */
    ...
    public:
        ...
        vector<uint16_t, 32> mixed_prefix;
    ...
    */
    ...
    public:
        ...
        bool re_train(bool save_after_retrain = true) {
            ...
            vector<uint8_t> unique_min_splits;
            vector<uint8_t> unique_min_leafs;
    ...
    */
    ...
    class Rf_pending_data{
        ...
        bool write_to_base_data(Rf_data& base_data){
            ...
            vector<Rf_sample> valid_samples;
        ...
        bool write_to_infer_log(){
            ...
            vector<rf_label_type> prediction_pairs;
    ...
    private:
        ...
        bool trim_log_file(const char* infer_log_path) {
            ...
            vector<uint8_t> remaining_data(remaining_data_size);
