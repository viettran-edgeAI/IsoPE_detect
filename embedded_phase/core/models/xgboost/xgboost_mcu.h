...
/**
 * @file xgboost_mcu.h
 * @brief XGBoost implementation for host/PC and embedded targets
 * 
 * This file provides a memory-efficient XGBoost classifier/runtime.
 * It is designed to load and run models trained from the project pipeline.
 * 
 * Features:
...
namespace eml {
    ...
    public:
        ...
        bool init(const char* model_name) {
            ...
            // 2) Logger next (shared init ordering)
            logger.init(&base);
        ...
        bool build_model() {
            ...
            // Allow calling build_model() directly without a pre-opened training session.
            if (!training_ctx) {
