 ...
 * @brief XGBoost components for inference/training
 *
 * This header defines the core XGBoost runtime types:
...
namespace eml {
    ...
    public:
        ...
        bool loadConfig(const char* config_path) {
            ...
            // Training ratios and runtime retraining parameters
    ...
    public:
        ...
        bool loadForest(const char* model_path) {
            ...
            eml_debug(1, "✅ Loaded compact model: ", packed_bytes, " bytes packed data + ", 
